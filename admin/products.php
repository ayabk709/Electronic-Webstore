...
$select_products->execute();
 if($select_products->rowCount() > 0){
         ...
         <tr>
            ...
            <td>
               <a href="update_product.php?update=<?= $fetch_products['id']; ?>"class="btn"><i class="fas fa-edit"></i> edit </a>
               <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="btn"> <i class="fas fa-trash"></i> delete </a>
            </td>
         </tr>
   <?php
         }
